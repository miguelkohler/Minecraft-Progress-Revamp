...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> PRIMITIVE_ARMOR_MATERIAL = register("primitive",
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection, int enchantability, float toughness,
        ...
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(ProgressRevamp.MODID, name);
