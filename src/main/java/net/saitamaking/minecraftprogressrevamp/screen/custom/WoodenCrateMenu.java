...
public class WoodenCrateMenu extends AbstractContainerMenu {
    public final WoodenCrateEntity blockEntity;
    private final Level level;


    public WoodenCrateMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public WoodenCrateMenu(int containerId, Inventory inv, BlockEntity blockEntity) {
        super(ModMenuTypes.WOODEN_CRATE_MENU.get(), containerId);
        this.blockEntity = ((WoodenCrateEntity) blockEntity);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.WOODENCRATE.get());
    }
